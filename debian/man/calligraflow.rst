...
========
  ...
  calligraflow [Qt-options] [KDE-options] [Calligra-options] [file] 
...
More detailed user documentation is available from **help:/calligraflow** (either enter this URL into Konqueror, or run **khelpcenter** *help:/calligraflow*).
